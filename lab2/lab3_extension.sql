...
-- This line bypasses foreign key checks so the script doesn't crash if customers are missing
...
INSERT INTO user_sessions (customer_id, session_date, pages_viewed, duration_mins, device, converted)
VALUES
...
-- Reset replication role to default after import
